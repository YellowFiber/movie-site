...
},{"./core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/TheHeader":"3Cyq4","./components/TheFooter":"b3x3c"}],"57bZf":[function(require,module,exports,__globalThis) {
///// Component /////
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
      ...
      <nav>
        <ul>
          ${this.state.menus.map((menu)=>{
            ...
            return /* html */ `
              <li>
                <a href="${menu.href}" class="${isActive ? 'active' : ''}">${menu.name}</a>
              </li>
            `;
        }).join("")}
        </ul>
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b3x3c":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
class TheFooter extends (0, _heropy.Component) {
    ...
    render() {
      ...
      <div>
        <a href="${github}" target="_blank">${new Date().getFullYear()} YellowFiber</a>
      </div>
    `;
    }
}
...
exports.default = new (0, _heropy.Store)({
    ...
    name: "YellowFiber",
    email: "dsa020175@gmail.com",
    blog: "https://yellowfiber.github.io/",
    github: "https://github.com/YellowFiber/",
    repository: "https://github.com/YellowFiber/movie-site"
});
...
},{"../core/heropy":"57bZf","./Home":"0JSNG","./Movie":"1LTyN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./About":"gdB30","./NotFound":"4fDiL"}],"0JSNG":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
},{"../core/heropy":"57bZf","../components/Headline":"gaVgo","../components/Search":"jqPPz","../components/MovieList":"8UDl3","../components/MovieListMore":"3ZUar","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gaVgo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
class Search extends (0, _heropy.Component) {
    render() {
        ...
        this.el.innerHTML = /* html */ `
      <input value="${(0, _movieDefault.default).state.searchText}" type="text" placeholder="Enter the movie title to search!" />
...
const getMovieDetails = async (id)=>{
    try {
        const res = await fetch(`https://omdbapi.com?apikey=feb5df74&i=${id}&plot=full`);
...
class MovieList extends (0, _heropy.Component) {
    ...
    `;
        ...
        if ((0, _movieDefault.default).state.loading) loaderEl.classList.remove("hide");
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../store/about":"4RAJO"}],"4fDiL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
